...
\begin{enumerate}
    \item How power screw can be applied in 3D printer axis?
    \item Explain lead, L. Use a diagram to illustrate your answer.
    ...
    \item A screw of M10x1.5 is used as a lead screw for a machine with a torque of 10 Nm travelled linearly at 10mm/s. Determine;
    \begin{enumerate}[label=(\roman*)]
        \item the mean diameter of the screw.
        \item angular speed of the screw in rpm.
        \item power carried by the screw.
    \end{enumerate}
    \item Label the torque on the screw, the torque on the handle, and the force on the screw. Discuss how to calculate the force on the screw if the load weight is 6kN, using appropriate labels.
    \item List three (3) factors that contribute to the efficiency of a square thread.
