...
\begin{enumerate}
    ...
    \item Find the equivalent radial load, P in a bearing used in the wheel if the radial load is 1 kN. (Outer ring rotates)
    \item Find Life adjustment factor, if 6\% probability of failure can be permitted.
    \item List two (2) important considerations for the selection of a rolling bearing.
