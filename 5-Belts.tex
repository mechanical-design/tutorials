...
Diameter of smaller pulley, $d_1$ = 300 mm = 0.3 m

Speed of smaller pulley, $n_1$ = 2800 rpm

Speed of larger pulley, $n_2$ = 1600 rpm
...
In a horizontal V belt drive for a centrifugal blower, the blower is belt driven at 600 rpm by a 15 kW, 1750rpm electric motor. The groove angle of the pulley is 35°. The center distance is twice the diameter of the larger pulley and velocity of the belt is 20 m/s. The density of the belt material is $1500 \, \text{kg/m}^3$ and maximum allowable stress is 4MPa. The coefficient of friction of motor pulley is 0.5. Determine
...
\textbf{Well-defined problem}
\vspace{10pt}

1.	If the area of the belt is reduced to $A=0.0001 \, \text{m}^2$, suggest the number of belts required using the same tensions in Question 1.
...
\hline
Belt Types & Specific Weight ($kg/m^3$) & $\sigma$ (MPa) & CoF & Dimension & Included angle \\
\hline
V-belt & 950 & 4 & 0.4 & A=2000mm\textsuperscript{3} & 38° \\
Round belt & 950 & 4 & 0.4 & d=2mm & - \\
\hline
\end{tabular}
\caption{Table Q2 Belt Types Comparison}
\end{table}
