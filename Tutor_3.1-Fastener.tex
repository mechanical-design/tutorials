...
\begin{enumerate}
    \item Discuss the functions and applications of fasteners in industries.
    ...
    \item Find Tensile stress area for M6 bolt. Compare it with the nominal cross-sectional area and cross-sectional area if root diameter is considered.
    \item If the external load acting on the bolt is increasing, list ONE (1) improvement that can be done to prevent the joint from separating by assuming the diameter and class number of the bolt are unchanged.
