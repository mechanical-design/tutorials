...
\begin{enumerate}
    \item Discuss application of riveted fasteners.
    \item State two types of material used for riveted connections.
    \item Differentiate axial force and shear force. Which force acting on riveted fasteners?
    \item State TWO (2) types of failure that commonly occur if the rivets are improperly designed and fastened.
    \item Find Shear Stress if load of 5kN is applied to a bolt with diameter of 16mm.
    \item A plate is 15 mm thick and the diameter of rivet is 20 mm. Determine the bearing stress if the resultant shear force is 20 kN.
...
$tan^{-1}\left(\dfrac{75}{60}\right) = 51.34^{\circ}$


\begin{equation*}
    \begin{aligned}
        \sum F_{Ax} &= F_{tA} \cos(51.34^{\circ})= 11057N\\
        \sum F_{Ay} &= F_{tA} \sin(51.34^{\circ}) + \frac{16000}{4}=17821N\\
        F_{A}&=\sqrt{F_{Ax}^2+F_{Ay}^2}=20972N
    \end{aligned}
\end{equation*}

Resultant force in Bolt A is $F_A=20972N$.
\vspace{10pt}
...
\begin{equation*}
    \begin{aligned}
        \sum F_{Bx} &= -F_{tB} \cos(51.34^{\circ})= -11057N\\
        \sum F_{By} &= F_{tB} \sin(51.34^{\circ}) + \frac{16000}{4}=17821N\\
        F_{B}&=\sqrt{F_{Bx}^2+F_{By}^2}=20972N
    \end{aligned}
\end{equation*}

Resultant force in Bolt B is $F_B=20972N$.\\
\vspace{10pt}
...
\begin{equation*}
    \begin{aligned}
        \sum F_{Cx} &= -F_{tC} \cos(51.34^{\circ})= -11057N\\
        \sum F_{Cy} &= \frac{16000}{4}-F_{tC} \sin(51.34^{\circ}) =9821N\\
        F_{C}&=\sqrt{F_{Cx}^2+F_{Cy}^2}=14789N
    \end{aligned}
\end{equation*}

Resultant force in Bolt C is $F_C=14789N$.\\
\vspace{10pt}
...
\begin{equation*}
    \begin{aligned}
        \sum F_{Dx} &= F_{tD} \cos(51.34^{\circ})= 11057N\\
        \sum F_{Dy} &= \frac{16000}{4}-F_{tD} \sin(51.34^{\circ}) =9821N\\
        F_{D}&=\sqrt{F_{Dx}^2+F_{Dy}^2}=14789N
    \end{aligned}
\end{equation*}

Resultant force in Bolt D is $F_D=14789N$.
\vspace{10pt}

ii - Find maximum shearing stress for the connection.
\vspace{10pt}

Compare resultant forces in each bolt, Bolt A and B has the highest load of 20972N compare than Bolt C and D of 14789N.
...
\begin{equation*}
    \begin{aligned}
        \tau &=\frac{20972}{\frac{\pi}{4}(0.016)^2} \\
        &=104.31 MPa
    \end{aligned}
\end{equation*}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{t32-q3-0.png}
    \captionsetup{labelformat=empty}
    \caption{Figure Q3}
\end{figure}
\vspace{10pt}
...
ii- Force at Rivet 2, $F_2=2523N$; Force at Rivet 3, $F_3=2527N$.

iii- Maximum shear stress, $\tau_{max}=4.95 MPa$ at Rivet 3.
